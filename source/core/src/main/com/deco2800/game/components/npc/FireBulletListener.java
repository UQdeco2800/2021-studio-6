...
public class FireBulletListener extends Component {
     ...
     */
    public FireBulletListener(Entity target, GameArea gameArea, String textureFileName) {
        this.target = target;
     ...
     */
    void fire() {
        EnemyBulletFactory.createBullet(this.entity, target, gameArea, textureFileName);
    }
