...
public class BulletFactory {
    ...
    public static Entity createBullet(Entity source, Entity target) {
        Entity bullet = new Entity()
                                .addComponent(new TextureRenderComponent("images/heart.png"))
                                .addComponent(new PhysicsComponent())
                                .addComponent(new bulletPhysicsMovementComponent());
...
//                                .addComponent(new HitboxComponent().setLayer(PhysicsLayer.NONE));
        ...
        bullet.getComponent(bulletPhysicsMovementComponent.class).setTarget(newTarget);
        bullet.getComponent(bulletPhysicsMovementComponent.class).setMoving(true);
        return bullet;
