...
public class TutorialNPCFactory {

    private TutorialNPCFactory(){
        throw new IllegalStateException("Utility Class");
    }


    public static Entity createNewTutorialNPC(StoryNames story, boolean wandering) {
        AnimationRenderComponent animator = new AnimationRenderComponent(
            ServiceLocator.getResourceService().getAsset("images/npc_movement/tut_npc1.atlas", TextureAtlas.class));
