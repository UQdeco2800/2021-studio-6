 ...
 */
public class BombColliderComponent extends Component {
  private static final Logger logger = LoggerFactory.getLogger(BombColliderComponent.class);

  private final FixtureDef fixtureDef;
  private Fixture fixture;

  public BombColliderComponent() {
   ...
   * @return self
   */
  public BombColliderComponent setAsBox(Vector2 size) {
   ...
   * @return self
   */
  public BombColliderComponent setAsBoxAligned(Vector2 size, AlignX alignX, AlignY alignY) {
   ...
   * @return self
   */
  public BombColliderComponent setAsBox(Vector2 size, Vector2 position) {
   ...
   * @return self
   */
  public BombColliderComponent setFriction(float friction) {
    if (fixture == null) {
   ...
   * @return self
   */
  public BombColliderComponent setSensor(boolean isSensor) {
    if (fixture == null) {
   ...
   * @return self
   */
  public BombColliderComponent setDensity(float density) {
    if (fixture == null) {
   ...
   * @return self
   */
  public BombColliderComponent setRestitution(float restitution) {
    if (fixture == null) {
   ...
   * @return self
   */
  public BombColliderComponent setShape(Shape shape) {
    if (fixture == null) {
   ...
   * @return self
   */
  public BombColliderComponent setLayer(short layerMask) {
    if (fixture == null) {
